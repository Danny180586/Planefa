 ...
 * @author Daniel
 */
public class JFProgramacionSupervisión extends javax.swing.JFrame {

    /**
     * Creates new form JFDatosGenerales
     */
    public JFProgramacionSupervisión() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFProgramacionSupervisión.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFProgramacionSupervisión().setVisible(true);
            }
        });
    }
